...
export type VisaTypeKey = 'spouse' | 'skilled_worker' | 'citizenship' | 'student';
...
export interface ChecklistItem {
  ...
  /** Tier gating: free = always accessible, unlocked = paywalled. Defaults to 'unlocked'. */
  tier?: 'free' | 'unlocked';
...
export const VISA_TYPES: Record<VisaTypeKey, VisaTypeInfo> = {
  ...
  student: {
    key: 'student',
    label: 'Student Visa',
    shortLabel: 'Student Visa',
    icon: '🎓',
    description: 'For international students aged 16+ with an unconditional offer from a UK licensed student sponsor. You need a CAS reference number, proof of funds covering tuition fees plus living costs (£1,171–£1,529/month for up to 9 months), and English language evidence at B1 or B2 level depending on your course.',
    govFee: '£558 (inside or outside UK)',
    ihsSurcharge: '£776/year (paid upfront for full visa duration)',
    processingTime: '3 weeks (outside UK) / 8 weeks (inside UK)',
    priorityAvailable: true,
    priorityFee: 'Varies — you will be told if faster processing is available when you apply',
    keyRequirements: [
      'Unconditional offer from a UK licensed student sponsor',
      'CAS (Confirmation of Acceptance for Studies) reference number from your institution',
      'Proof of funds: course fee (1 year) + £1,529/month in London or £1,171/month outside London for up to 9 months',
      'Funds held for 28 consecutive days ending within 31 days of application date',
      'English language: B1 level minimum (below degree) or B2 (degree level and above)',
      'ATAS certificate if your course and nationality require it (sensitive subjects)',
      'TB test certificate if from a listed country and studying for 6+ months',
    ],
  },
...
export const CHECKLISTS: Record<VisaTypeKey, ChecklistItem[]> = {
  ...
  spouse: [
    ...
    {
      id: 'sp-location-status',
      title: 'Confirm Your Current Location',
      description: 'Declare whether you are currently inside or outside the UK. This determines your application route (entry clearance vs. leave to remain), the fees you pay, and your processing timeline.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'No document upload required — written declaration in your application form',
      tips: 'Applying from inside the UK (FLR route) costs less and is faster for some visa types. Applying from outside the UK (entry clearance) has different fees and timelines. Make sure your route matches your actual location.',
      displayOrder: 200,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/apply-to-come-to-the-uk',
      commonMistakes: ['Applying on the wrong route (inside vs outside UK)', 'Leaving the UK between application submission and decision without permission'],
      bestPractices: ['Confirm your route with official UKVI guidance before applying', 'Do not travel internationally after submitting without checking your permissions'],
    },
    {
      id: 'sp-previous-refusal',
      title: 'Previous Visa Refusal Disclosure',
      description: 'If you have ever been refused a visa to the UK or any other country, you must disclose this in your application. Failure to disclose is grounds for immediate refusal and can result in a ban.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Written disclosure in application form + supporting explanation letter if applicable',
      tips: 'A previous refusal does not automatically disqualify you — but failing to disclose one does. If refused previously, include a clear explanation of what has changed since and why you now meet the requirements.',
      displayOrder: 201,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/guidance/immigration-rules/immigration-rules-introduction',
      commonMistakes: ['Not disclosing a refusal because it was "minor" or "a long time ago"', 'Not addressing what has changed since the previous refusal'],
      bestPractices: ['Disclose every refusal — UK, US, Schengen, anywhere', 'Write a clear cover letter explaining the circumstances and changes since'],
    },
    {
      id: 'sp-previous-overstay',
      title: 'Immigration Overstay Disclosure',
      description: 'If you have ever stayed in the UK or any country beyond your permitted leave, this must be declared. Overstays are recorded by border agencies and will be discovered during checks.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Written disclosure in application form + explanation letter',
      tips: 'An undisclosed overstay is almost always discovered and results in immediate refusal plus potential entry ban. Disclose early, explain the circumstances, and show you have since maintained lawful status.',
      displayOrder: 202,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/guidance/immigration-rules',
      commonMistakes: ['Assuming a short overstay "doesn\'t count"', 'Not mentioning an overstay that occurred in another country'],
      bestPractices: ['Disclose all overstays regardless of length or country', 'Include a letter explaining the circumstances and evidence of your subsequent lawful immigration status'],
    },
    {
      id: 'sp-employment-status',
      title: 'Employment Status & Proof',
      description: 'Confirm your current employment status (employed, self-employed, unemployed, student, retired). This affects which financial documents you need to gather and how the Home Office will assess your application.',
      category: 'financial',
      required: true,
      priority: 'important',
      formatRequired: 'Supporting documents vary: payslips (employed), SA302 tax returns (self-employed), pension statements (retired)',
      tips: 'Employment status dictates your entire financial evidence package. Get clarity on your status first — then gather the right documents. Self-employed applicants often underestimate how much documentation they need.',
      displayOrder: 203,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/apply-to-come-to-the-uk',
      commonMistakes: ['Gathering payslips when self-employed (need SA302 instead)', 'Not providing enough months of evidence for variable income'],
      bestPractices: ['Confirm your employment category with your accountant or employer before gathering documents', 'Self-employed: get your last 2 years of SA302s from HMRC'],
    },
    {
      id: 'sp-relationship-duration',
      title: 'Relationship Duration Evidence',
      description: 'Evidence of how long you and your partner have been in a genuine relationship. The Home Office uses this to assess whether your relationship is genuine and subsisting.',
      category: 'supporting',
      required: true,
      priority: 'critical',
      formatRequired: 'Photos, messages, travel records, financial ties, correspondence — covering the full relationship period',
      tips: 'The longer and better-documented your relationship history, the stronger your application. Aim for evidence spanning your entire relationship, not just the recent months.',
      displayOrder: 204,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/uk-family-visa/partner-spouse',
      commonMistakes: ['Only providing recent evidence — the Home Office wants the full history', 'Using only digital photos without metadata or context'],
      bestPractices: ['Organise evidence chronologically', 'Include photos, messages, flight records, hotel bookings, shared financial accounts, and any correspondence across the full relationship'],
    },
  ],
  ...
  // =========================================================================
  student: [
    // ── FREE AI PREVIEW ITEMS ────────────────────────────────────────────────
    {
      id: 'st-free-identity-verification',
      title: 'Passport Identity & Fraud Check (Free AI Preview)',
      description: 'Upload your passport (all pages). Our AI checks expiry date, MRZ integrity, and name consistency with your other documents — the identity issues that cause instant refusals.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'PDF or JPG — all passport pages including blank pages',
      tips: 'Passport issues are a top cause of preventable visa refusals. This free check takes 30 seconds and flags expiry dates, MRZ damage, and name inconsistencies before they become problems.',
      displayOrder: 1,
      tier: 'free',
      isFreeItem: true,
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      officialRequirement: 'You must provide a current passport or other valid travel documentation.',
      commonMistakes: ['Passport expires within 6 months of course start', 'Name on passport differs from university offer letter or CAS', 'MRZ zone scratched or partially obscured'],
      bestPractices: ['Renew passport if it expires within 6 months', 'Ensure name matches exactly across ALL documents', 'Scan at 300 DPI minimum — every single page'],
      aiFeatures: { confidenceScoring: true, riskFlagging: true },
    },
    {
      id: 'st-free-financial-validation',
      title: 'Bank Statements — 28-Day Funds Check (Free AI Preview)',
      description: 'Upload your bank statements. Our AI calculates whether your balance meets the required threshold (£1,529/month in London or £1,171/month outside London), checks the 28-consecutive-day rule, and verifies the end date is within 31 days of your application — the most common cause of student visa refusals.',
      category: 'financial',
      required: true,
      priority: 'critical',
      formatRequired: 'PDF or JPG — official bank statements covering the 28-day window',
      tips: 'Financial evidence is the #1 reason for student visa refusals. The rules are precise: funds must be held continuously for 28 days AND the end of that 28-day window must fall within 31 days of your application date. This free check catches those issues before you submit.',
      displayOrder: 2,
      tier: 'free',
      isFreeItem: true,
      govLink: 'https://www.gov.uk/student-visa/money',
      officialRequirement: 'You must show funds of £1,529/month (London) or £1,171/month (outside London) for up to 9 months, plus your course fees. These funds must be held for at least 28 consecutive days with the end date within 31 days of your application.',
      commonMistakes: ['Balance dips below threshold even briefly during the 28-day period', '28-day window ends more than 31 days before the application date', 'Using screenshots instead of official bank statements', 'Not including course fee amount on top of living costs'],
      bestPractices: ['Request official stamped statements from your bank', 'Plan your application date to ensure the 28-day window end date is recent', 'Calculate your exact requirement: (months of course up to 9) × monthly rate + course fees'],
      aiFeatures: { confidenceScoring: true, riskFlagging: true, multiDocValidation: true },
    },
    {
      id: 'st-free-accommodation-check',
      title: 'Accommodation & Address Consistency Check (Free AI Preview)',
      description: 'Upload your proof of UK accommodation (tenancy agreement, university halls letter, or landlord letter). Our AI extracts the address and checks it for consistency across your documents.',
      category: 'supporting',
      required: true,
      priority: 'critical',
      formatRequired: 'PDF or JPG — tenancy agreement, university accommodation letter, or landlord confirmation',
      tips: 'Your accommodation must be adequate and not overcrowded. A tenancy agreement, university halls confirmation, or a landlord letter confirming your arrangements all work. Address consistency across documents matters.',
      displayOrder: 3,
      tier: 'free',
      isFreeItem: true,
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      officialRequirement: 'You may need to provide proof of adequate accommodation in the UK.',
      commonMistakes: ['Expired tenancy agreement that does not cover the course period', 'Address on accommodation proof differs from bank statements', 'Not providing university halls confirmation letter when living in halls'],
      bestPractices: ['Ensure tenancy/halls confirmation covers your full course period', 'Address must match across all your documents', 'University halls: get an official letter from your accommodation office'],
      aiFeatures: { confidenceScoring: true, riskFlagging: true, addressExtraction: true },
    },
    ...
    // ── PERSONAL DOCUMENTS ───────────────────────────────────────────────────
    {
      ...
      description: 'Your current passport with at least 6 months validity. Include all previous passports showing travel history.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Original + colour copy of every page (including blank pages)',
      tips: 'If your passport expires within 6 months of your intended course start, renew it before applying. Previous passports show travel history and should always be included.',
      displayOrder: 4,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      officialRequirement: 'You must provide a current passport or other valid travel documentation.',
      commonMistakes: ['Not including blank pages', 'Passport expiring within 6 months of course start', 'Missing previous passports'],
      bestPractices: ['Scan every page at 300 DPI including blank ones', 'Use colour scans — black and white not accepted', 'Include all old passports even if expired'],
    },
    {
      id: 'st-biometrics',
      title: 'Biometric Enrolment Confirmation',
      description: 'Proof you have enrolled your fingerprints and photo at a Visa Application Centre (VAC). You can only book this AFTER submitting your online application.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Digital confirmation or appointment receipt',
      tips: 'Book your biometrics appointment immediately after submitting your online application. Slots fill quickly, especially between September and January when most students are applying.',
      displayOrder: 5,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/find-a-visa-application-centre',
      officialRequirement: 'Once you submit your visa application, UKVI will ask you to book and attend a biometrics appointment.',
      commonMistakes: ['Booking before submitting the online application', 'Waiting too long to book after submission', 'Going to wrong VAC location'],
      bestPractices: ['Book within 24 hours of online submission', 'Research VAC locations before you apply', 'Bring your passport and application confirmation to the appointment'],
    },
    {
      id: 'st-photos',
      title: 'Passport-Style Photographs',
      description: 'Digital passport photo for online applications or 2 printed photos for paper applications. Must be taken within the last month.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Digital (600×750px min, 50KB–10MB) for online OR 2 printed 45mm×35mm for paper',
      tips: 'Use a photo booth or professional service. Plain light background, no glasses, neutral expression. Photos older than 1 month will be rejected.',
      displayOrder: 6,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/photos-for-passports',
      commonMistakes: ['Photos older than 1 month', 'Wearing glasses', 'Dark or patterned background', 'Shadows on face'],
      bestPractices: ['Photo booth recommended for best approval odds', 'Plain white or light grey background', 'Look straight at the camera with neutral expression'],
    },
    {
      id: 'st-previous-refusal',
      title: 'Previous Visa Refusal Disclosure',
      description: 'If you have ever been refused a visa to the UK or any other country, you must disclose this. Failure to disclose is grounds for immediate refusal and can result in a ban.',
      category: 'personal',
      required: true,
      priority: 'critical',
      formatRequired: 'Written disclosure in application form + explanation letter if applicable',
      tips: 'A previous refusal does not automatically disqualify you — undisclosed ones almost always do. Include a clear explanation of what has changed since the previous refusal.',
      displayOrder: 7,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/guidance/immigration-rules',
      commonMistakes: ['Not disclosing because the refusal was minor or old', 'Not addressing what has changed since'],
      bestPractices: ['Disclose every refusal — UK, US, Schengen, anywhere', 'Write a cover letter explaining the circumstances'],
    },
    {
      id: 'st-tb-test',
      title: 'Tuberculosis (TB) Test Certificate',
      description: 'Required if you are from a listed country and studying in the UK for more than 6 months. Must be from a UKVI-approved clinic.',
      category: 'personal',
      required: false,
      priority: 'important',
      formatRequired: 'Original certificate from UKVI-approved clinic (do not upload — submit to VAC)',
      tips: 'Check if your country is on the TB test list. Common countries: India, Pakistan, Bangladesh, Nigeria, Ghana, Zimbabwe. Book your test early — approved clinics can be busy and results take a few days.',
      displayOrder: 8,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/tb-test-visa',
      officialRequirement: 'You must provide a TB test certificate from a UKVI-approved clinic if you are from a listed country and applying for a visa for more than 6 months.',
      commonMistakes: ['Using a clinic not on the UKVI-approved list', 'Not checking if your country requires the test', 'Submitting too close to your application date (allow time for results)'],
      bestPractices: ['Check the gov.uk TB test list before booking', 'Book at least 2 weeks before your intended application date', 'Certificate is valid — do not laminate or alter'],
    },

    // ── FINANCIAL DOCUMENTS ──────────────────────────────────────────────────
    {
      id: 'st-bank-statements',
      title: 'Bank Statements (28-Day Funds Window)',
      description: 'Official bank statements showing you hold sufficient funds for at least 28 consecutive days, with the end of that period within 31 days of your application date.',
      category: 'financial',
      required: true,
      priority: 'critical',
      formatRequired: 'Official stamped bank statements (not online screenshots or printouts)',
      tips: 'Calculate your exact requirement: (number of course months up to 9) × monthly rate (£1,529 London / £1,171 outside) + first year tuition fee. Funds must not dip below this at any point in the 28-day window.',
      displayOrder: 9,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/money',
      officialRequirement: 'Bank statements must show the required funds held for at least 28 consecutive days. The end date of the 28-day period must be within 31 days of the date of application.',
      commonMistakes: ['Balance briefly dips during the 28-day window', 'Statements end more than 31 days before application', 'Not including tuition fee amount in the calculation', 'Using online printouts without a bank stamp'],
      bestPractices: ['Request official stamped statements from your bank branch', 'Plan application date carefully to keep the 28-day window current', 'Keep funds stable — do not withdraw large amounts during the window'],
    },
    {
      id: 'st-course-fee-evidence',
      title: 'Course Fee Evidence',
      description: 'Evidence confirming your first year tuition fee amount. This is usually on your CAS but you may need additional documentation from your university confirming the fee.',
      category: 'financial',
      required: true,
      priority: 'critical',
      formatRequired: 'University fee letter or CAS confirmation (the CAS reference contains fee information)',
      tips: 'Your CAS already contains your course fee information. If you have paid a deposit, include evidence of that payment — it reduces the amount of funds you need to show in your bank.',
      displayOrder: 10,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/money',
      officialRequirement: 'You must show you have enough money to pay for your course for one academic year (up to 9 months). The amount is stated on your CAS.',
      commonMistakes: ['Not accounting for course fees in total funds calculation', 'Not deducting already-paid deposit from required balance'],
      bestPractices: ['If you have paid a deposit, include receipt — it reduces the balance requirement', 'Check your CAS for the exact fee amount stated'],
    },
    {
      id: 'st-financial-sponsor-letter',
      title: 'Financial Sponsor Letter (if applicable)',
      description: 'If someone else (parent, government, employer) is sponsoring your fees and/or living costs, you need an official letter from them confirming the sponsorship details.',
      category: 'financial',
      required: false,
      priority: 'important',
      formatRequired: 'Official letter on headed paper confirming: sponsor name, relationship to you, amount, duration, and what is covered',
      tips: 'The sponsor must also provide their own bank statements showing they hold the funds. A letter alone is not sufficient — financial evidence from the sponsor is required.',
      displayOrder: 11,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/money',
      officialRequirement: 'Written consent for your application from your financial sponsor if you have received sponsorship for your course fees and living costs in the last 12 months.',
      commonMistakes: ['Not including sponsor bank statements alongside the letter', 'Letter missing required fields (amount, duration, relationship)', 'Using an informal letter rather than official headed paper'],
      bestPractices: ['Ask sponsor to provide official letter on headed paper or bank letterhead', 'Include sponsor bank statements covering same period as student statements', 'Clearly state what is being sponsored: fees only, living costs, or both'],
    },
    {
      id: 'st-student-loan-evidence',
      title: 'Student Loan / Scholarship Evidence (if applicable)',
      description: 'If you have a student loan or scholarship, provide the official award letter. This can count towards your financial requirement.',
      category: 'financial',
      required: false,
      priority: 'important',
      formatRequired: 'Official loan/scholarship award letter showing amount, duration, and payment schedule',
      tips: 'Student loans from official lenders (government student loans, UK university bursaries) are accepted as financial evidence. Private loans are generally not accepted unless from a regulated lender.',
      displayOrder: 12,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/money',
      officialRequirement: 'If you have a student loan or financial sponsorship, provide evidence of this from your loan or sponsorship company.',
      commonMistakes: ['Not providing the official loan letter from Student Finance England / equivalent', 'Using informal scholarship emails rather than official award letters'],
      bestPractices: ['Download the official loan entitlement letter from your loan provider portal', 'Scholarship: get the official award letter from the university awards office'],
    },
    ...
    // ── SUPPORTING DOCUMENTS ─────────────────────────────────────────────────
    {
      ...
      description: 'A unique reference number issued by your UK university once they have offered and you have accepted your place. This is the cornerstone of your student visa application.',
      category: 'supporting',
      required: true,
      priority: 'critical',
      formatRequired: 'CAS reference number (format: X1P00000000000X000). You do not submit a physical document — enter the number in your online application.',
      tips: 'Your CAS expires. Check the expiry date — it must be valid when you submit your application. Your university will not issue a CAS until you have an unconditional offer and have accepted your place.',
      displayOrder: 13,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      officialRequirement: 'You must have a CAS from a licensed student sponsor (your university or college). The CAS contains your course details, tuition fees, and the sponsor licence number.',
      commonMistakes: ['CAS expired before application submission', 'Course details on CAS do not match university offer letter', 'Applying before receiving your CAS reference number'],
      bestPractices: ['Request your CAS as soon as you have accepted your unconditional offer', 'Check CAS expiry date — apply before it expires', 'Verify all details on the CAS match your offer letter exactly'],
    },
    {
      id: 'st-english-language',
      title: 'English Language Test Results (IELTS / SELT)',
      description: 'Proof your English meets the required level: B1 (CEFR) for below-degree courses, B2 for degree-level and above. Most applicants use IELTS Academic or a UKVI-approved Secure English Language Test (SELT).',
      category: 'supporting',
      required: true,
      priority: 'critical',
      formatRequired: 'Original test certificate or TRF (Test Report Form) number. IELTS: min 4.0 per component for B1, 5.5 per component for B2.',
      tips: 'IELTS results are valid for 2 years. If your test is more than 2 years old at the time of application, you will need to retake it. Some nationalities and qualifications are exempt — check gov.uk.',
      displayOrder: 14,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/knowledge-of-english',
      officialRequirement: 'You must prove you can speak, read, write and understand English at the required CEFR level for your course.',
      commonMistakes: ['IELTS certificate more than 2 years old at application date', 'Score meets overall requirement but individual component below minimum', 'Using wrong test type (IELTS General instead of Academic)'],
      bestPractices: ['Check your course requirement: B1 or B2', 'Verify certificate is within 2-year validity at your intended application date', 'IELTS Academic (not General) is required for most university courses'],
    },
    {
      id: 'st-academic-qualifications',
      title: 'Academic Qualifications & Transcripts',
      description: 'Your previous academic qualifications that demonstrate you meet the entry requirements for your course. Required to support your genuine student assessment.',
      category: 'supporting',
      required: true,
      priority: 'critical',
      formatRequired: 'Degree certificates, transcripts, A-level certificates, or equivalent. Non-English documents must have certified translations.',
      tips: 'The Home Office assesses whether you are a genuine student who can complete the course. Strong academic qualifications from your home country significantly support this assessment.',
      displayOrder: 15,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      commonMistakes: ['Not providing certified translation for non-English documents', 'Providing unofficial transcript instead of official sealed copy', 'Missing qualifications relevant to your chosen course'],
      bestPractices: ['Get official sealed transcripts from your previous institutions', 'Use ITI or NRPSI accredited translators for certified translations', 'Include all relevant qualifications including secondary school if applying for undergraduate'],
    },
    {
      id: 'st-atas-certificate',
      title: 'ATAS Certificate (Academic Technology Approval Scheme)',
      description: 'Required if you are a national of certain countries and your course involves sensitive subjects (advanced physics, mathematics, engineering, chemistry). Apply through the FCDO — takes up to 20 working days.',
      category: 'supporting',
      required: false,
      priority: 'critical',
      formatRequired: 'ATAS certificate issued by the FCDO. Must match course and institution on your CAS.',
      tips: 'Check whether your course and nationality require ATAS before applying for your visa. If required and not provided, your visa will be refused regardless of everything else. Apply for ATAS well in advance — processing takes up to 20 working days.',
      displayOrder: 16,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/guidance/academic-technology-approval-scheme',
      officialRequirement: 'A valid ATAS certificate is required if your course and nationality require it. The certificate must match the details on your CAS.',
      commonMistakes: ['Not checking ATAS requirement before applying', 'ATAS certificate details do not match CAS (course code, institution)', 'Applying for visa before ATAS is issued'],
      bestPractices: ['Check ATAS requirement at gov.uk before any other prep', 'Apply for ATAS as soon as you have your CAS reference', 'Allow 20+ working days for ATAS processing before your visa application'],
    },
    {
      id: 'st-parental-consent',
      title: 'Parental / Guardian Consent (Under 18 Only)',
      description: 'If you are under 18, you need written consent from both parents or legal guardians covering: your visa application, your living arrangements in the UK, and your travel to the UK. Plus a copy of your birth certificate.',
      category: 'supporting',
      required: false,
      priority: 'critical',
      formatRequired: 'Signed consent letters from both parents (or sole guardian if applicable) + birth certificate',
      tips: 'Both parents must sign unless one has sole parental responsibility. The consent must explicitly cover all three areas: visa application, living arrangements, and travel. A generic consent letter may be rejected.',
      displayOrder: 17,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/student-visa/documents-you-must-provide',
      officialRequirement: 'If you are under 18, you need written consent from both parents or legal guardians for your visa application, your living and care arrangements in the UK, and your travel to the UK.',
      commonMistakes: ['Only getting one parent to sign when both are required', 'Consent letter not covering all three required areas', 'Not including birth certificate showing parent names'],
      bestPractices: ['Use the consent letter template from gov.uk guidance as a base', 'Have both parents sign separately if they live apart', 'Include certified translations if birth certificate is not in English'],
    },
    {
      id: 'st-criminal-record',
      title: 'Criminal Record Declaration',
      description: 'Declare any criminal convictions in any country. Good character is assessed as part of the student visa application.',
      category: 'supporting',
      required: true,
      priority: 'important',
      formatRequired: 'Written declaration in application form + Criminal Record Certificate if applicable',
      tips: 'Minor convictions declared early with context are rarely disqualifying. Undisclosed convictions discovered by the Home Office are almost always disqualifying. Declare everything.',
      displayOrder: 18,
      tier: 'unlocked',
      govLink: 'https://www.gov.uk/guidance/immigration-rules',
      commonMistakes: ['Not disclosing a conviction because it was spent or minor', 'Not disclosing convictions from other countries'],
      bestPractices: ['Disclose all convictions regardless of country or age', 'Include a cover letter explaining context for any convictions'],
    },
  ],
};
...
export const RISKS: RiskRule[] = [
  ...
  // =========================================================================
  {
    id: 'student-funds-insufficient',
    title: 'Insufficient Funds for Student Visa',
    description: 'Your bank statements may not show sufficient funds. Student visa requires course fees (year 1) + living costs of £1,529/month in London or £1,171/month outside London for up to 9 months.',
    severity: 'high',
    recommendation: 'Recalculate your exact requirement and ensure funds are visible in your bank statements for the full 28-day window.',
    conditions: {
      visaTypes: ['student'],
    },
  },
  {
    id: 'student-atas-required',
    title: 'ATAS Certificate May Be Required',
    description: 'If your course involves advanced physics, maths, engineering, chemistry, or other sensitive subjects, you may need an ATAS certificate from the FCDO before applying. This takes up to 20 working days.',
    severity: 'high',
    recommendation: 'Check gov.uk ATAS guidance immediately. If required, apply before submitting your student visa — missing ATAS is an automatic refusal.',
    conditions: {
      visaTypes: ['student'],
    },
  },
  {
    id: 'student-tb-test',
    title: 'TB Test May Be Required',
    description: 'If you are from India, Pakistan, Bangladesh, Nigeria, Ghana, Zimbabwe, or other listed countries and studying for 6+ months, you need a TB test from a UKVI-approved clinic.',
    severity: 'medium',
    recommendation: 'Check the gov.uk TB test list. If applicable, book your test now — allow 2+ weeks before your application date.',
    conditions: {
      visaTypes: ['student'],
    },
  },
  {
    id: 'student-cas-expiry',
    title: 'Confirm CAS Expiry Date',
    description: 'Your CAS has an expiry date. If it expires before you submit your application, your institution must reissue it.',
    severity: 'medium',
    recommendation: 'Check your CAS expiry date immediately. If it is within 30 days, contact your university international office to reissue.',
    conditions: {
      visaTypes: ['student'],
    },
  },
