...
// =============================================================================
// STUDENT VISA TEMPLATES (12)
// =============================================================================

const STUDENT_TEMPLATES: DocumentTemplate[] = [
  {
    id: 'student-passport',
    visaType: 'student',
    title: 'Valid Passport — Student Visa',
    shortTitle: 'Valid Passport (All Pages)',
    whatIsThis:
      'Your passport is the primary identity document for your student visa application. The Home Office uses it to verify your identity, nationality, and travel history. Without a valid passport, your application cannot proceed.',
    homeOfficeRequires:
      'Appendix Student of the Immigration Rules requires: "The applicant must provide a valid current passport or other valid travel documentation." The passport must cover the intended period of study.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum for scanned pages',
      maxFileSize: '6 MB per page',
      ...
      additionalSpecs: [
        'Scan every page, including blank pages',
        'Bio data page must be flat with no glare or shadows',
        'All visa stamps and endorsements must be legible',
        'Use PDF for multi-page submissions',
      ],
    },
    whatToInclude: [
      'Bio data page (photo, name, date of birth, passport number, expiry)',
    ...
    commonMistakes: [
      'Only scanning the bio data page — UKVI needs every single page',
      'Blurry or glare-affected scan of the photo page',
      'Passport expiring within 6 months of course start date',
      'Name on passport not matching university offer letter or CAS',
      'Forgetting to include previous or expired passports',
    ],
    proTips: [
      'Place passport flat on a dark background and scan at 300 DPI for best clarity',
      'Use Adobe Scan or similar scanning app — far better than a regular phone photo',
      'Renew your passport BEFORE applying if it expires within 6 months of course start',
      'Name must match exactly across passport, CAS, and offer letter — any discrepancy needs explanation',
      'Include all old passports even if expired — shows consistent travel history',
    ],
    checklist: [
      'Bio data page scanned in full colour at 300+ DPI',
      'All stamped pages scanned (both sides if needed)',
      'All blank pages scanned',
      'Previous passports scanned if available',
      'Passport has 6+ months validity remaining beyond course start',
      'Name exactly matches CAS and university offer letter',
      'File is under 6 MB per page',
      'PDF format for multi-page submission',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/documents-you-must-provide',
    category: 'personal',
    priority: 'critical',
  },
  {
    id: 'student-cas',
    visaType: 'student',
    title: 'Confirmation of Acceptance for Studies (CAS) — Student Visa',
    shortTitle: 'CAS Reference',
    whatIsThis:
      'Your CAS (Confirmation of Acceptance for Studies) is a unique reference number issued by your UK university or college once they have offered you a place and you have formally accepted it. It is the cornerstone of your student visa application — without it, you cannot apply.',
    homeOfficeRequires:
      'Appendix Student of the Immigration Rules requires: "The applicant must have been assigned a CAS by a licensed Student sponsor." The CAS must be current and not expired. It contains your course details, fee amount, and the institution’s sponsor licence number.',
    formatSpecs: {
      fileTypes: ['N/A — entered as a reference number'],
      resolution: 'N/A',
      maxFileSize: 'N/A',
      colorMode: 'N/A',
      additionalSpecs: [
        'CAS format: X1P00000000000X000 (alphanumeric)',
        'Enter directly into your online application — no physical document upload',
        'Keep a screenshot or printout of your CAS details for reference',
        'Your institution will email you the CAS number',
      ],
    },
    whatToInclude: [
      'Your CAS reference number (enter in online application)',
      'Verify: institution name matches your offer letter',
      'Verify: course title and level match your offer letter',
      'Verify: course start and end dates are correct',
      'Verify: tuition fee amount stated on CAS',
      'Verify: CAS expiry date — must apply before this date',
    ],
    commonMistakes: [
      'CAS expires before the application is submitted — contact university to reissue',
      'Course details on CAS do not match university offer letter',
      'Applying before receiving your CAS reference number',
      'Entering the CAS number incorrectly (typo in alphanumeric string)',
    ],
    proTips: [
      'Request your CAS as soon as you accept your unconditional offer — do not delay',
      'Check the CAS expiry date the moment you receive it and plan your application accordingly',
      'Cross-check every field: institution, course name, level, start date, fee — errors must be corrected by the university before you apply',
      'If your course details change, your university must update the CAS before you submit',
      'Screenshot your CAS confirmation email and file it somewhere safe',
    ],
    checklist: [
      'CAS reference number received from institution',
      'CAS expiry date verified and is in the future',
      'Institution name on CAS matches offer letter exactly',
      'Course title and level match offer letter',
      'Course start date matches offer letter',
      'Tuition fee amount visible on CAS',
      'CAS reference entered correctly in online application',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/documents-you-must-provide',
    category: 'supporting',
    priority: 'critical',
  ...
  {
    id: 'student-bank-statements',
    visaType: 'student',
    title: 'Bank Statements — 28-Day Funds Window — Student Visa',
    shortTitle: 'Bank Statements (28-Day Funds)',
    whatIsThis:
      'Official bank statements proving you hold sufficient funds to cover your course fees and living costs. This is the most scrutinised document in student visa applications and the most common cause of refusal when submitted incorrectly.',
    homeOfficeRequires:
      'Appendix Student requires: funds of £1,529/month in London or £1,171/month outside London for up to 9 months of your course, PLUS your first year tuition fee. These funds must be held continuously for at least 28 consecutive days. The end date of the 28-day period must be within 31 days of the date you submit your application.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI for scanned paper statements',
      maxFileSize: '6 MB per page',
      colorMode: 'Colour preferred; clear black and white accepted if fully legible',
      additionalSpecs: [
        'Must be official statements — not online screenshots or printouts',
        'Bank stamp and/or official header required',
        'All transaction rows must be clearly readable',
        'Account holder name must exactly match passport',
      ],
    },
    whatToInclude: [
      'Official bank statements covering the full 28-day window',
      ...
      'All transactions clearly visible with no redactions',
      'Statement end date within 31 days of your application date',
    ],
    commonMistakes: [
      'Balance dips below the required threshold even briefly during the 28-day window — instant failure',
      '28-day window end date is more than 31 days before the application date',
      'Using online banking printouts or screenshots instead of official statements',
      'Not including the course fee amount in the calculation (living costs only is not enough)',
      'Account holder name differs from passport (even slightly)',
    ],
    proTips: [
      'Calculate precisely: (months of course, up to 9) × (£1,529 London / £1,171 outside) + first year tuition fee',
      'If you have paid a deposit already, deduct it from the tuition fee portion of the calculation',
      'Request official stamped statements from your bank branch — do not rely on online downloads',
      'Plan your application date: work backwards from when your 28-day window ends to stay within the 31-day rule',
      'Do not make large withdrawals during the 28-day window — even if you replace the funds later, it still counts as a dip',
    ],
    checklist: [
      'Calculated exact funds requirement (course months × rate + tuition fee)',
      'Balance meets or exceeds requirement throughout all 28 days',
      'Statement end date is within 31 days of intended application date',
      'Statements are official (stamped / on letterhead, not screenshots)',
      'Account holder name matches passport exactly',
      'All transactions visible and readable',
      'Account number and sort code / IBAN visible',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/money',
    category: 'financial',
    priority: 'critical',
  },
  {
    ...
    visaType: 'student',
    title: 'Course Fee Evidence — Student Visa',
    shortTitle: 'Course Fee Evidence',
    whatIsThis:
      'Documentation confirming your first year tuition fee amount. This figure is essential for calculating the total funds you must hold in your bank account. It is stated on your CAS but may also need to be confirmed separately.',
    homeOfficeRequires:
      'Appendix Student requires that you hold sufficient funds to cover your first year tuition fees in addition to your living costs. The fee amount on your CAS is used by UKVI to assess your financial requirement.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour or clear black and white',
      additionalSpecs: [
        'University fee letter should be on headed paper',
        'CAS screenshot showing fee amount is acceptable as supporting reference',
        'Deposit receipt must show amount paid and date',
      ],
    },
    whatToInclude: [
      'First year tuition fee amount (from CAS or university fee letter)',
      'Any deposit already paid (with payment receipt)',
      'Calculation: full fee minus deposit already paid = remaining balance needed in bank',
      'University fee letter on headed paper if CAS fee differs from invoice',
    ],
    commonMistakes: [
      'Not accounting for course fees in the total funds calculation (living costs only is insufficient)',
      'Not deducting an already-paid deposit from the required bank balance',
      'Using estimated fees — must use the exact figure on the CAS',
    ],
    proTips: [
      'Cross-check: the fee on your CAS must match the university’s fee schedule for your course and year',
      'If you have paid a deposit, include the receipt — it directly reduces your bank balance requirement',
      'If your fee changes between CAS issue and application, get your institution to update the CAS before you apply',
    ],
    checklist: [
      'First year tuition fee amount confirmed from CAS',
      'Any deposit paid evidenced with receipt',
      'Remaining balance requirement calculated correctly',
      'Bank statements reflect total requirement (living costs + remaining tuition fee)',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/money',
    category: 'financial',
    priority: 'critical',
  ...
  {
    id: 'student-english-ielts',
    visaType: 'student',
    title: 'English Language Test Results (IELTS / SELT) — Student Visa',
    shortTitle: 'IELTS / English Language Certificate',
    whatIsThis:
      'Proof that your English meets the required level for your course. Most students use IELTS Academic or a UK Visas and Immigration (UKVI)-approved Secure English Language Test (SELT). The minimum level depends on your course: B1 for below-degree, B2 for degree-level and above.',
    homeOfficeRequires:
      'Appendix Student requires English language evidence at CEFR B1 (IELTS overall 4.0, each component 4.0) for below-degree level courses, or B2 (IELTS overall 5.5, each component 5.5) for degree-level and above. The test must be taken within 2 years of the application date.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI for scanned certificates',
      maxFileSize: '6 MB',
      colorMode: 'Colour scan required — black and white not accepted',
      additionalSpecs: [
        'Test Report Form (TRF) number must be visible',
        'All four component scores must be visible (Listening, Reading, Writing, Speaking)',
        'Certificate must show test date for validity verification',
        'Original certificate preferred; certified copy accepted if original not available',
      ],
    },
    whatToInclude: [
      'Test Report Form (TRF) number',
      'Overall band score',
      'Individual component scores: Listening, Reading, Writing, Speaking',
      'Test date (must be within 2 years of application)',
      'Candidate name (must match passport)',
      'Test type: IELTS Academic (not IELTS General Training)',
    ],
    commonMistakes: [
      'IELTS certificate is more than 2 years old at the application date — automatic rejection',
      'Overall score meets requirement but one component is below the per-component minimum',
      'Using IELTS General Training instead of IELTS Academic for degree-level applications',
      'Candidate name on certificate differs from passport name',
    ],
    proTips: [
      'Check whether you need B1 or B2: below degree = B1, degree and above = B2',
      'IELTS Academic is required for most university courses — General Training is NOT accepted',
      'Verify your certificate is within 2 years of your intended application date — if close, retake proactively',
      'Download your results from the IELTS portal immediately after receiving them to ensure you have a digital copy',
      'Some nationalities and qualifications are exempt — check gov.uk before booking a test',
    ],
    checklist: [
      'Test Report Form (TRF) number visible',
      'Overall band score meets requirement (4.0 for B1, 5.5 for B2)',
      'Each component score meets requirement individually',
      'Test type is IELTS Academic (not General Training)',
      'Test date is within 2 years of intended application date',
      'Candidate name matches passport exactly',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/knowledge-of-english',
    category: 'supporting',
    priority: 'critical',
  },
  {
    id: 'student-academic-qualifications',
    visaType: 'student',
    title: 'Academic Qualifications & Transcripts — Student Visa',
    shortTitle: 'Academic Qualifications',
    whatIsThis:
      'Your previous academic qualifications and official transcripts proving you meet the entry requirements for your chosen course and demonstrating your genuine student intention. These support the Home Office’s assessment of whether you are a genuine student.',
    homeOfficeRequires:
      'Appendix Student requires that applicants demonstrate a genuine intention to study. Academic qualifications are not formally mandated but are strongly expected to demonstrate course eligibility and genuine student intent. They form part of the credibility assessment.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI for scanned certificates',
      maxFileSize: '6 MB per document',
      colorMode: 'Colour scan preferred',
      additionalSpecs: [
        'Official sealed transcripts preferred over unofficial printouts',
        'Non-English documents must have a certified translation attached',
        'Certified translations by ITI or NRPSI accredited translators only',
      ],
    },
    whatToInclude: [
      'Degree certificate(s) for highest completed qualification',
      'Official academic transcripts with all grades/marks',
      'A-level or equivalent secondary certificates if applying for undergraduate',
      'Certified English translations for all non-English language documents',
      'Ecctis (NARIC) confirmation if using a non-UK qualification to meet entry requirements',
    ],
    commonMistakes: [
      'Not providing a certified translation for non-English documents — unofficial translations are rejected',
      'Providing an unofficial transcript printout instead of an official sealed copy',
      'Not including secondary qualifications when applying for an undergraduate course',
    ],
    proTips: [
      'Request official sealed transcripts from your institutions — most universities have a dedicated process for this',
      'Use ITI or NRPSI accredited translators for certified translations — list is available online',
      'Ecctis (formerly NARIC) confirmation is useful if your overseas qualification equivalency is not obvious',
      'Include all qualifications relevant to your course — a strong academic track record supports your genuine student assessment',
    ],
    checklist: [
      'Degree certificate(s) included for all completed qualifications',
      'Official sealed transcripts included',
      'Secondary qualifications included if applying for undergraduate',
      'Certified translations attached for all non-English documents',
      'Translations are by ITI or NRPSI accredited translators',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/documents-you-must-provide',
    category: 'supporting',
    priority: 'critical',
  },
  {
    ...
    visaType: 'student',
    title: 'Accommodation Evidence — Student Visa',
    shortTitle: 'Accommodation Proof',
    whatIsThis:
      'Proof that you have adequate accommodation arranged in the UK for the duration of your study. This can be a tenancy agreement, a university halls confirmation letter, or a landlord letter.',
    homeOfficeRequires:
      'Appendix Student states: you may be asked to provide evidence of adequate accommodation in the UK. Accommodation must not be overcrowded. Address consistency across all documents is important.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour preferred',
      additionalSpecs: [
        'Must show full UK address including postcode',
        'Must cover the intended study period',
        'University halls: official letter from accommodation office on headed paper',
        'Private tenancy: signed tenancy agreement showing both parties’ names',
      ],
    },
    whatToInclude: [
      'Full UK address (house number, street, city, postcode)',
      'Duration: start and end date of accommodation arrangement',
      'Landlord or accommodation provider name and contact details',
      'For university halls: official confirmation letter from the accommodation office',
      'For private rental: signed tenancy agreement',
    ],
    commonMistakes: [
      'Expired tenancy agreement that does not cover the course period',
      'Address on accommodation proof differs from bank statement billing address',
      'Not getting an official university halls letter — email confirmation is not sufficient',
    ],
    proTips: [
      'Ensure accommodation covers your full course period — short-term arrangements are not sufficient',
      'Address must match across all your documents: accommodation proof, bank statements, and any other address-bearing documents',
      'University halls: request an official letter from the accommodation office, not just an email confirmation',
    ],
    checklist: [
      'Full UK address visible including postcode',
      'Accommodation covers the full course period',
      'Document is official (signed tenancy or university headed letter)',
      'Address matches bank statement and other documents',
      'Landlord or accommodation provider details visible',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/documents-you-must-provide',
    category: 'supporting',
    priority: 'critical',
  },
  {
    id: 'student-tb-test',
    visaType: 'student',
    title: 'Tuberculosis (TB) Test Certificate — Student Visa',
    shortTitle: 'TB Test Certificate',
    whatIsThis:
      'A TB test certificate from a UKVI-approved clinic is required if you are from a listed country and applying to study in the UK for more than 6 months. The test checks you do not have active tuberculosis before entering the UK.',
    homeOfficeRequires:
      'Immigration Rules require: you must provide a valid TB test certificate from a UKVI-approved clinic if you are a national of a listed country and applying for a visa lasting more than 6 months. Common listed countries include India, Pakistan, Bangladesh, Nigeria, Ghana, Zimbabwe, and many others.',
    formatSpecs: {
      fileTypes: ['Original certificate (do not upload)', 'PDF copy for reference'],
      resolution: 'N/A — original submitted to VAC in person',
      maxFileSize: 'N/A',
      colorMode: 'Original document — do not laminate or alter',
      additionalSpecs: [
        'Must be from a UKVI-approved clinic (check gov.uk list)',
        'Submit original at your VAC biometrics appointment',
        'Do NOT upload as part of your online application',
        'Certificate is valid for 6 months from test date',
      ],
    },
    whatToInclude: [
      'Applicant full name and date of birth',
      'Test result: satisfactory / clear',
      'Test date (within 6 months of visa application)',
      'Clinic name and address (must be on UKVI approved list)',
      'Authorised clinic stamp and signature',
    ],
    commonMistakes: [
      'Using a clinic not on the UKVI-approved list — certificate will be rejected',
      'Not checking whether your country requires the test before applying',
      'Submitting too close to your application date without allowing time for results',
      'Laminating or altering the certificate in any way',
    ],
    proTips: [
      'Check the full TB test country list on gov.uk — many applicants are surprised to find their country is listed',
      'Book your test at least 2-3 weeks before your intended application date to allow time for results',
      'Only UKVI-approved clinics are accepted — private hospitals or GPs are generally not approved',
      'Submit the original certificate at your VAC biometrics appointment, not via upload',
    ],
    checklist: [
      'Confirmed country is on the TB test required list (gov.uk)',
      'Test booked at a UKVI-approved clinic',
      'Test result is satisfactory / clear',
      'Certificate within 6 months of application date',
      'Applicant name and date of birth visible and matches passport',
      'Clinic stamp and signature present',
      'Original certificate kept — to be submitted at VAC appointment',
    ],
    govUkReference: 'https://www.gov.uk/tb-test-visa',
    category: 'personal',
    priority: 'important',
  },
  {
    id: 'student-atas',
    visaType: 'student',
    title: 'ATAS Certificate (Academic Technology Approval Scheme) — Student Visa',
    shortTitle: 'ATAS Certificate',
    whatIsThis:
      'ATAS is a UK government scheme requiring nationals of certain countries to obtain approval before studying courses involving sensitive subjects (advanced physics, chemistry, mathematics, engineering, and related fields). The certificate is issued by the Foreign, Commonwealth & Development Office (FCDO).',
    homeOfficeRequires:
      'Appendix Student requires: a valid ATAS certificate must be provided if the applicant’s course and nationality require it. Failure to provide a required ATAS certificate results in automatic visa refusal. Processing takes up to 20 working days.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour print or scan',
      additionalSpecs: [
        'Certificate issued via FCDO ATAS portal',
        'Must match course details and institution on CAS exactly',
        'ATAS certificate number must be visible',
        'Apply well in advance — allow 20+ working days',
      ],
    },
    whatToInclude: [
      'ATAS certificate number',
      'Applicant name (matching passport)',
      'Course / subject description (matching CAS)',
      'Institution name (matching CAS)',
      'Certificate validity period',
    ],
    commonMistakes: [
      'Not checking the ATAS requirement before applying for the visa — automatic refusal if missed',
      'Course or institution name on ATAS does not exactly match CAS details',
      'Applying for the student visa before ATAS certificate is received',
      'Not allowing sufficient time: 20 working days minimum processing',
    ],
    proTips: [
      'Check the ATAS requirement first on gov.uk before any other preparation — it can delay your entire timeline',
      'Apply for ATAS as soon as you receive your CAS reference — do not wait',
      'The FCDO ATAS portal is free to use and requires your CAS details',
      'If your course changes after ATAS is issued, you may need a new ATAS certificate',
      'Sensitive subjects include: advanced physics, mathematics, engineering, chemistry, and related disciplines — check the full list on gov.uk',
    ],
    checklist: [
      'Confirmed whether course and nationality require ATAS',
      'Applied for ATAS through FCDO portal with CAS details',
      'ATAS certificate received (allow 20+ working days)',
      'Certificate number visible',
      'Course details on ATAS match CAS exactly',
      'Institution name on ATAS matches CAS exactly',
      'Certificate is within validity period',
    ],
    govUkReference: 'https://www.gov.uk/guidance/academic-technology-approval-scheme',
    category: 'supporting',
    priority: 'critical',
  },
  {
    id: 'student-financial-sponsor-letter',
    visaType: 'student',
    title: 'Financial Sponsor Letter — Student Visa',
    shortTitle: 'Financial Sponsor Letter',
    whatIsThis:
      'If someone other than yourself is paying for your tuition fees or living costs (a parent, relative, government body, or employer), you need an official letter from them confirming the sponsorship. This letter alone is not sufficient — it must be supported by the sponsor’s bank statements.',
    homeOfficeRequires:
      'Appendix Student requires: written consent for the application from any financial sponsor if the applicant has received sponsorship for course fees and/or living costs in the past 12 months. The sponsor must also provide financial evidence showing they hold the funds.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour scan of original letter',
      additionalSpecs: [
        'Must be on official headed paper or bank letterhead',
        'Letter must be signed by named individual',
        'Sponsor’s bank statements must be provided alongside the letter',
        'Non-English letters must have certified translations',
      ],
    },
    whatToInclude: [
      'Sponsor full name',
      'Relationship to the applicant (e.g. parent, employer)',
      'Amount being sponsored (annual or total)',
      'Duration of sponsorship (must cover course period)',
      'What is being sponsored: tuition fees only, living costs only, or both',
      'Sponsor’s bank statements showing they hold the funds (same 28-day window rules apply)',
      'Sponsor’s signature on headed paper',
    ],
    commonMistakes: [
      'Providing sponsor letter without accompanying sponsor bank statements — letter alone is rejected',
      'Letter missing required fields (amount, duration, what is being sponsored)',
      'Using an informal email or personal letter instead of official headed paper',
      'Not providing certified translations for non-English letters',
    ],
    proTips: [
      'The sponsor’s bank statements must show the same 28-day window with sufficient funds, just as your own would',
      'Ask the sponsor to write on official headed paper or bank letterhead — a plain letter is not sufficient',
      'Clearly specify what is being sponsored — fees only, living costs only, or both',
      'Certified translation is required for any non-English language letter',
    ],
    checklist: [
      'Sponsor full name and relationship stated',
      'Amount and duration of sponsorship stated',
      'What is covered clearly stated (fees / living costs / both)',
      'Letter on official headed paper and signed',
      'Sponsor bank statements covering 28-day window included',
      'Certified translation included if non-English',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/money',
    category: 'financial',
    priority: 'important',
  ...
  {
    id: 'student-parental-consent',
    visaType: 'student',
    title: 'Parental / Guardian Consent — Under 18 — Student Visa',
    shortTitle: 'Parental Consent (Under 18)',
    whatIsThis:
      'If you are under 18, both parents or legal guardians must provide written consent covering three specific areas: the visa application itself, your living and care arrangements in the UK, and your travel to the UK. A birth certificate is also required.',
    homeOfficeRequires:
      'Appendix Student requires: if the applicant is under 18, written consent from both parents or legal guardians for the visa application, for the applicant’s living and care arrangements in the UK, and for the applicant’s travel to the UK.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour scan of signed originals',
      additionalSpecs: [
        'Both parents must sign unless one has sole parental responsibility',
        'Birth certificate required to show parent-child relationship',
        'Non-English documents must have certified translations',
        'Letters should explicitly name all three consent areas',
      ],
    },
    whatToInclude: [
      'Parent/guardian full name and relationship',
      'Consent for the visa application',
      'Consent for living and care arrangements in the UK',
      'Consent for travel to the UK',
      'Birth certificate (showing parent names)',
      'If sole parental responsibility: court order or equivalent evidence',
    ],
    commonMistakes: [
      'Only getting one parent to sign when both are required',
      'Generic consent letter that does not explicitly cover all three areas',
      'Not including the birth certificate',
      'Not providing certified translations for non-English documents',
    ],
    proTips: [
      'Use the consent letter guidance on gov.uk as a template — ensure all three consent areas are explicitly named',
      'If parents live apart, each parent can sign a separate letter — both are still required',
      'Include certified translations of the birth certificate if it is not in English',
      'If one parent has sole parental responsibility, provide the court order confirming this',
    ],
    checklist: [
      'Consent letter covers all three areas: visa application, living arrangements, and travel',
      'Both parents have signed (or sole parental responsibility evidence provided)',
      'Birth certificate included',
      'Certified translations included for non-English documents',
      'Parent/guardian full name and relationship clearly stated in letter',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/documents-you-must-provide',
    category: 'supporting',
    priority: 'important',
  ...
  {
    id: 'student-student-loan',
    visaType: 'student',
    title: 'Student Loan / Scholarship Evidence — Student Visa',
    shortTitle: 'Student Loan / Scholarship',
    whatIsThis:
      'Official evidence of a student loan or scholarship that contributes to your financial requirement. Official loans from government student loan bodies and university bursaries are accepted. Private loans are generally not accepted unless from a regulated lender.',
    homeOfficeRequires:
      'Appendix Student states: if the applicant has a student loan or financial sponsorship from an official body, evidence of this should be provided. Official loans and government scholarships can count towards the financial requirement.',
    formatSpecs: {
      fileTypes: ['PDF', 'JPEG'],
      resolution: '300 DPI minimum',
      maxFileSize: '6 MB',
      colorMode: 'Colour scan of official document',
      additionalSpecs: [
        'Must be an official entitlement letter from the loan provider or scholarship body',
        'Informal emails from universities are not sufficient for scholarships',
        'Official award letter on headed paper required',
        'Amount, payment schedule, and duration must be clearly stated',
      ],
    },
    whatToInclude: [
      'Loan/scholarship body name',
      'Applicant name (matching passport)',
      'Total loan or scholarship amount',
      'Payment schedule (when funds are released)',
      'Duration of award',
      'What is covered: tuition, living costs, or both',
    ],
    commonMistakes: [
      'Using an informal email from a university about a scholarship instead of the official award letter',
      'Not downloading the official loan entitlement letter from the student loan provider portal',
      'Private loan letters — generally not accepted unless from a regulated financial institution',
    ],
    proTips: [
      'Download your official loan entitlement letter from the Student Finance England portal (or equivalent) — not just the email confirmation',
      'Scholarship: contact the university awards office directly and request a formal award letter on headed paper',
      'If the scholarship covers only tuition and not living costs, you still need to demonstrate living cost funds separately',
      'Government-funded scholarships (Chevening, Commonwealth, etc.) are well-regarded — always include the award letter',
    ],
    checklist: [
      'Official loan entitlement letter from loan provider or scholarship body',
      'Loan/scholarship amount clearly stated',
      'Payment schedule included',
      'Duration of award covers study period',
      'What is covered stated (tuition / living costs / both)',
      'Applicant name matches passport',
    ],
    govUkReference: 'https://www.gov.uk/student-visa/money',
    category: 'financial',
    priority: 'important',
...
export const VISA_TEMPLATE_COUNTS: Record<VisaTypeKey, number> = {
  ...
  student: STUDENT_TEMPLATES.length,
};
